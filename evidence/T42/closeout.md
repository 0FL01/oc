...
T42 finished: implementation commit `ff5fae5` (this report and the four fixes), qualification
evidence in `evidence/T42/`. State: T42 done, T27 ready next (bounded live campaign on the
production path), T30 FINAL after it. The product is offline-qualified only; READY requires
the mandatory live PASS.
