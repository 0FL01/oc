...
- Smallest next action: **owner requested T44 pause after this S03 checkpoint and priority startup RECON**, not another implementation slice. The owner last reported catalog HTTP 401/403 under their zsh; this process's distinct inherited product credential returned catalog 200/selected model and release Home. No claim of equal credentials or real owner-profile startup. The current release distinguishes 401 and 403; `evidence/tui/recovery-startup/owner-catalog-recon.md` records the same-shell status-only discrimination plan. S03 actual PTY effects are checked in `evidence/tui/recovery-v07-s03/{report,checkpoint}.md`; S05/S06/S08, S07 resources, VIS and missing genuine actions remain open pending resumption.
