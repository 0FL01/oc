...
- Smallest next action: V06b reasoning/tool/partial-patch/live-versus-durable replay, actual provider/tool effects and pinned-original paired captures. V06a table parser and indexed viewport are locally verified but whole-frame comparison remains unequal. Typed release-startup diagnostics are verified only against isolated config; the user's real-profile cause is not known. V04 missing backend/service capabilities remain unavailable, not fabricated controls.
...
- Next: V06a Markdown tables/parser and indexed viewport tested, actual paired table regions 490/490 and 2688/2688 styled cells equal but both whole frames DIFFERENT. See `evidence/tui/recovery-v06a/checkpoint.md` for attempts and limitations; VIS13/VIS14/R4 remain unverified. V06b reasoning/tool/patch/live-replay, V07–V09 and genuine missing backend/service actions are open. Isolated release-binary startup and safe diagnostics qualified in `evidence/tui/recovery-startup/checkpoint.md`; owner real-profile cause remains unknown and private config was not accessed. Positive live visual inspection is not a waiver; native autoaccept remains Unsupported (`evidence/tui/recovery-v02/auto-capability.md`).
